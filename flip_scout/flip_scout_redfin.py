...
ALREADY_RENOVATED_FLAGS = [
    ...
    'newly remodeled', 'refurbished kitchen', 'reimagined home', 'fully reimagined',
    'reimagined residence', 'waterfall island', 'contemporary design',
    ...
    'extensively remodeled', 'updated eat-in kitchen', 'newer cabinets',
    'totally remodeled', 'beautifully restored', 'refinished hardwood', 'all you have to do is move in',
    'all you have to do is to move in', 'nothing to do but move in',
]
